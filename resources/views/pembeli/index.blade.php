...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <center><div class="card-header">Pembeli</div></center>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $data->telepon}}</td>
                                <td class="d-flex">
                                    <a href="{{ route('pembeli.edit',$data->id) }}" class="btn btn-success ms-1">Edit</a>
                                    <a href="{{ route('pembeli.show',$data->id) }}" class="btn btn-warning  ms-1">Show</a>
